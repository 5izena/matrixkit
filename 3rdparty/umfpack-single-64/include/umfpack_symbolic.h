...
UMFPACK_MYFLOAT int Syntax:
    ...
    UMFPACK_MYFLOAT Control [UMFPACK_CONTROL], Info [UMFPACK_INFO], *Ax ;
...
complex int Syntax:
    ...
    void *Symbolic ;
    int n_row, n_col, *Ap, *Ai, status ;
    UMFPACK_MYFLOAT Control [UMFPACK_CONTROL], Info [UMFPACK_INFO], *Ax, *Az ;
...
Arguments:
    ...
    UMFPACK_MYFLOAT Ax [nz] ;	Optional input argument, not modified.  May be NULL.
    ...
    UMFPACK_MYFLOAT Az [nz] ;	Optional input argument, not modified, for complex
	...
	**Symbolic is the address of a (void *) pointer variable in the user's
    ...
    UMFPACK_MYFLOAT Info [UMFPACK_INFO] ;	Output argument, not defined on input.

	Contains statistics about the symbolic analysis.  If a (UMFPACK_MYFLOAT *) NULL
