...
(
    ...
    UMFPACK_MYFLOAT *Ex,
    void *NumericHandle,
    UMFPACK_MYFLOAT User_Info [UMFPACK_INFO]
) ;
...
UMFPACK_MYFLOAT int Syntax:
    ...
    void *Numeric ;
    int status ;
    UMFPACK_MYFLOAT Mx, Ex, Info [UMFPACK_INFO] ;
...
complex int Syntax:
    ...
    void *Numeric ;
    int status ;
    UMFPACK_MYFLOAT Mx, Mz, Ex, Info [UMFPACK_INFO] ;
...
Purpose:
    ...
    for the UMFPACK_MYFLOAT case, or

      UMFPACK_MYFLOAT det [2] ;
...
Arguments:
    ...
    UMFPACK_MYFLOAT *Mx ;   Output argument (array of size 1, or size 2 if Mz is NULL)
    UMFPACK_MYFLOAT *Mz ;   Output argument (optional)
    UMFPACK_MYFLOAT *Ex ;   Output argument (optional)
