...
UMFPACK_MYFLOAT int Syntax:
    ...
    UMFPACK_MYFLOAT *Ax, Control [UMFPACK_CONTROL] ;
...
complex int Syntax:
    ...
    #include "umfpack.h"
    int n_row, n_col, *Ap, *Ai, status ;
    UMFPACK_MYFLOAT *Ax, *Az, Control [UMFPACK_CONTROL] ;
...
Arguments:
    ...
    UMFPACK_MYFLOAT Ax [nz] ;	Input argument, not modified, of size nz = Ap [n].
