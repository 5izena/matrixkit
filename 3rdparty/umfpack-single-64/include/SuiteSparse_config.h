...
/* data type defines what the numerical type is (double or float): */
#ifndef UMFPACK_MYFLOAT
#define UMFPACK_MYFLOAT float
#define UMFPACK_SINGLE 1	/* all numerical values are float */
#endif
...
struct SuiteSparse_config_struct
{
    ...
    UMFPACK_MYFLOAT (*hypot_func) (UMFPACK_MYFLOAT, UMFPACK_MYFLOAT) ;     /* pointer to hypot */
    int (*divcomplex_func) (UMFPACK_MYFLOAT, UMFPACK_MYFLOAT, UMFPACK_MYFLOAT, UMFPACK_MYFLOAT, UMFPACK_MYFLOAT *, UMFPACK_MYFLOAT *);
} ;
...
UMFPACK_MYFLOAT SuiteSparse_hypot (UMFPACK_MYFLOAT x, UMFPACK_MYFLOAT y) ;

/* complex division of c = a/b */
int SuiteSparse_divcomplex
(
    UMFPACK_MYFLOAT ar, UMFPACK_MYFLOAT ai,	/* real and imaginary parts of a */
    UMFPACK_MYFLOAT br, UMFPACK_MYFLOAT bi,	/* real and imaginary parts of b */
    UMFPACK_MYFLOAT *cr, UMFPACK_MYFLOAT *ci	/* real and imaginary parts of c */
) ;
