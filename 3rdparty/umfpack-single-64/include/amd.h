...
(
    ...
    UMFPACK_MYFLOAT Control [ ],        /* input Control settings, of size AMD_CONTROL */
    UMFPACK_MYFLOAT Info [ ]            /* output Info statistics, of size AMD_INFO */
) ;
 ...
 *       Control:  a UMFPACK_MYFLOAT array of size AMD_CONTROL, containing control
 ...
 *       Info: a UMFPACK_MYFLOAT array of size AMD_INFO, containing statistical
...
void amd_defaults   (UMFPACK_MYFLOAT Control [ ]) ;
void amd_l_defaults (UMFPACK_MYFLOAT Control [ ]) ;

/* amd_control: prints the control settings */
void amd_control    (UMFPACK_MYFLOAT Control [ ]) ;
void amd_l_control  (UMFPACK_MYFLOAT Control [ ]) ;

/* amd_info: prints the statistics */
void amd_info       (UMFPACK_MYFLOAT Info [ ]) ;
void amd_l_info     (UMFPACK_MYFLOAT Info [ ]) ;
