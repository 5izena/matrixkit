...
(
    ...
    int Rp [ ],
    int Ri [ ],
    UMFPACK_MYFLOAT Rx [ ], UMFPACK_MYFLOAT Rz [ ],
    int do_conjugate
) ;
...
Arguments:
    ...
    UMFPACK_MYFLOAT Rx [nz] ;	Output argument.
			Size 2*nz if Az or Rz are NULL.
    UMFPACK_MYFLOAT Rz [nz] ;	Output argument, imaginary part for complex versions.
